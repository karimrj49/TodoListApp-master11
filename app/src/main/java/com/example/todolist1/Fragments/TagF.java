...
public class TagF extends Fragment implements FragmentRecyclerViewAdapter.OnFragmentListner{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mainActivity.getSupportActionBar().setTitle("Tags");
        ...
        tagViewModel.getAllTagtitle().observe(this, new Observer<List<String>>() {
            @Override
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0 , ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Tag P = null;
                try {
                    P = tagViewModel.getTagById(viewHolder.getAdapterPosition()+1);
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
                tagViewModel.delete(P);
    ...
    public void onFragmentClick(int position) {
        ...
        String title = null;
        try {
            Tag T = tagViewModel.getTagById(rpos);
            title = T.getTitle();
        } catch (ExecutionException e) {
            e.printStackTrace();
        } catch (InterruptedException e) {
        ...
        ActionWithTag actionWithTag = new ActionWithTag();
        actionWithTag.setArguments(bundle);

        fragmentTransaction.replace(R.id.fragment_container,actionWithTag,"tag");
